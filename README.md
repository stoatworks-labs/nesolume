...
**[v1.0.5](https://github.com/stoatworks-labs/nesolume/releases/tag/v1.0.5)** — prebuilt for macOS, Windows and Linux. Pick your platform:
...
| Build | Download | Size |
| --- | --- | --- |
| Universal (Apple Silicon + Intel) · .dmg disk image | [`nesolume-1.0.5-macos-universal.dmg`](https://github.com/stoatworks-labs/nesolume/releases/download/v1.0.5/nesolume-1.0.5-macos-universal.dmg) | 202 KB |
...
| Build | Download | Size |
| --- | --- | --- |
| x64 · .exe installer | [`nesolume-1.0.5-windows-x86_64-setup.exe`](https://github.com/stoatworks-labs/nesolume/releases/download/v1.0.5/nesolume-1.0.5-windows-x86_64-setup.exe) | 216 KB |
