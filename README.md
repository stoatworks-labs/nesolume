...
**[v1.0.2](https://github.com/stoatworks-labs/nesolume/releases/tag/v1.0.2)** — prebuilt for macOS and Windows. Pick your platform:
...
| Build | Download | Size |
| --- | --- | --- |
| Universal (Apple Silicon + Intel) · .dmg disk image | [`nesolume-1.0.2-macos-universal.dmg`](https://github.com/stoatworks-labs/nesolume/releases/download/v1.0.2/nesolume-1.0.2-macos-universal.dmg) | 211 KB |
...
| Build | Download | Size |
| --- | --- | --- |
| x64 · .exe installer | [`nesolume-1.0.2-windows-x86_64-setup.exe`](https://github.com/stoatworks-labs/nesolume/releases/download/v1.0.2/nesolume-1.0.2-windows-x86_64-setup.exe) | 216 KB |
