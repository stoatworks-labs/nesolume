...
**[v1.0.1](https://github.com/stoatworks-labs/nesolume/releases/tag/v1.0.1)** — prebuilt for macOS and Windows. Pick your platform:
...
| Build | Download | Size |
| --- | --- | --- |
| Universal (Apple Silicon + Intel) · .dmg disk image | [`nesolume-1.0.1-macos-universal.dmg`](https://github.com/stoatworks-labs/nesolume/releases/download/v1.0.1/nesolume-1.0.1-macos-universal.dmg) | 206 KB |
...
| Build | Download | Size |
| --- | --- | --- |
| x64 · .exe installer | [`nesolume-1.0.1-windows-x86_64-setup.exe`](https://github.com/stoatworks-labs/nesolume/releases/download/v1.0.1/nesolume-1.0.1-windows-x86_64-setup.exe) | 213 KB |
