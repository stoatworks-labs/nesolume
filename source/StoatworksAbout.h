...
namespace stoatworks::about
{
    ...
    inline constexpr auto hook = "Retro console hardware for Resolume";
    inline constexpr auto licence = "MIT";
    inline constexpr auto guide = "https://stoatworks-labs.com/software/nesolume/guide/";
    inline constexpr auto page = "https://stoatworks-labs.com/software/nesolume/";
    inline constexpr auto repo = "https://github.com/stoatworks-labs/nesolume";
    inline constexpr auto versionFallback = "v1.1.0";
